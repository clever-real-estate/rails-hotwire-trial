...
ActiveRecord::Schema[8.1].define(version: 2026_04_21_034627) do
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["photo_likes_count"], name: "index_photos_on_photo_likes_count"
    t.index ["photographer_name"], name: "index_photos_on_photographer_name"
  end
